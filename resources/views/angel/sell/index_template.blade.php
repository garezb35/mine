<tr>
    ...
    <td>
        ...
        <div id="game_money">
            최소
            <input type="text" name="user_quantity_min" id="user_quantity_min" maxlength="7" class="angel__text f_right">
            <span class="unit"></span> 게임머니 ~
            최대
            <input type="text" name="user_quantity_max" id="user_quantity_max" maxlength="7" class="angel__text f_right">
...
<tr>
    <th>판매금액</th>
    <td>
        <input type="text" name="user_division_unit" id="user_division_unit" maxlength="7" class="angel__text f_right" size="18">
        <span class="unit"></span> 게임머니 당
        <input type="text" name="user_division_price" id="user_division_price" maxlength="10" class="angel__text f_right" size="18"> 원에 판매합니다.
