    ...
    <div>
        <div class="pagecontainer">
            <form id="frmSell" name="frmSell" action="/application_ok" method="post">
                ...
                @if($user_goods_type == 'division')
                    <table class="table-striped table-green1 P__r ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>최소구매수량</th>
                                <td class="e--pc">{{number_format($user_quantity_min)}}{{$game_unit}} {{$goods_label}}</td>
                                <th class="visible--table--pc">최대구매수량</th>
                                <td class="visible--table--pc">{{number_format($user_quantity_max)}}{{$game_unit}} {{$goods_label}}</td>
                            </tr>
                            <tr class="visible--table-m">
                                <th>최대구매수량</th>
                                <td colspan="3">{{number_format($user_quantity_max)}}{{$game_unit}} {{$goods_label}}</td>
                            </tr>
                            <tr>
                                <th>구매수량</th>
                                <td class="e--pc">
                                    <input type="text" id="buy_quantity" name="buy_quantity" class="angel__text mode-active text__new__green input__height__30 border__new_green" value="0"> 번 (<span id="spnQuantity_Unit">{{$user_division_unit}}</span> x
                                    <span id="spnQuantity"></span>번 =
                                    <span id="spnQuantity_total"></span>{{$game_unit}} {{$goods_label}})
                                </td>
                                <th class="visible--table--pc">단위금액</th>
                                <td  class="visible--table--pc">{{$user_division_unit}}{{$game_unit}}당 {{number_format($user_division_price)}}원</td>
                            </tr>
                            <tr class="visible--table-m">
                                <th>단위금액</th>
                                <td colspan="3">{{$user_division_unit}}{{$game_unit}}당 {{number_format($user_division_price)}}원</td>
                            </tr>
                            <tr>
                                <th>복수구매할인</th>
                                ...
                                <td  class="visible--table--pc"><span class="trade_money1"></span> 원</td>
                            </tr>
                            <tr class="visible--table-m">
                                <th>예상결제금액</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="float-left">
                                <input type="text" name="user_character" id="user_character" class="angel__text mode-active text__new__green input__height__30 border__new_green" maxlength="30" tabindex="2"> 물품을 전달 받으실 본인의 캐릭터명 </div>
                ...
                <div class="highlight_contextual_nodemon mt-10">결제정보</div>
                <table class="table-striped table-green1">
                    <colgroup>
                        <col width="160">
                        <col/>
                    ...
                    <tr>
                        <th>구매금액</th>
                        <td class="e--pc"><span class="trade_money1">{{number_format($user_price)}}</span>원</td>
                        <th class="visible--table--pc">내 마일리지</th>
                        <td class="visible--table--pc">{{number_format($cuser['mileage'])}}원</td>
                    </tr>
                    <tr class="visible--table-m">
                        <th>내 마일리지</th>
                        <td colspan="3">{{number_format($cuser['mileage'])}}원</td>
                    </tr>
                    <tr>
                        <th>사용할 마일리지</th>
                        <td colspan="3">
                            <input type="text" class="w60 angel__text mode-active text__new__green input__height__30 border__new_green" id="use_mileage" name="use_mileage" value="" readonly="" disabled="">원
                        </td>
                    </tr>
                    </tbody>
                </table>
                ...
                <div class="b_input_group">
                    <a id="buy_btn" onclick="fnApplication(0);" class="button-success">구매신청</a>
                    <a href="/sell/view?id={{$orderNo}}" class="button-cancel">취소</a>
                </div>
            </form>
        </div>
        ...
        <form action="https://bill.tcash.co.kr/PublicWeb/TCashDeposit.aspx" method="post" target="tcash_charge" id="tcash_frm">
            ...
            <input type="hidden" id="tcash_payment_phone" value="">
        </form>
        <div class="empty-high"></div>
    </div>
    </div>
