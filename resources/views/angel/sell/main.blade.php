        ...
        <div class="pagecontainer_full">
            ...
            <div class="registration_info">
                ...
                <div class="info_display">
                    ...
                    <div class="info_tap_img"><img src="/angel/img/icons/push__icon.png"></div>
                    <div class="infos_tap">판매수량/금액입력</div>
                    <div class="info_tap_img"><img src="/angel/img/icons/push__icon.png"></div>
            ...
            <form name="frmSell" id="frmSell" method="post" enctype="multipart/form-data" action="/addService">
                ...
                <div class="mmm ml-15 mr-15">
                    <table class="table-primary border--gap border-top-0 sell__buy__table P__r">
                        ...
                        <tr>
                            <th class="border-top bg-gradient-wb">판매유형</th>
                            <td class="border-top">
                                <label @class('d-none')><input type="radio" name="user_goods_type" class="g_radio first_radio" value="general" checked id="u_goods_general">일반</label>
                                <label id="division" @class('d-none')><input type="radio" name="user_goods_type" class="g_radio" value="division" id="u_goods_division">분할</label>
                        ...
                        <tr>
                            ...
                            <td class="border-top">
                                ...
                                <input type="text" class="w-100 f-14 text__new__green input__height__30 border__new_green pl-5" name="user_title" id="user_title" maxlength="40" value="게임머니 팝니다.">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="bg-white border-top">
                                ...
                                <textarea id="user_text" name="user_text" class="txtarea w100 border__new_green" readonly>게임머니 팝니다.</textarea>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th class="border-top bg-gradient-wb">파일추가</th>
                            <td class="bg-white border-top" id="image_preview">
                                <div class="screen_guide2 m-t-10">
                                    <a @class('upload__btn')><i @class('fa fa-cloud-upload')></i> 파일 올리기</a>
                                    <input type="file" name="user_screen[]" multiple="multiple" id="btnAtt" @class('d-none')>
                                    <br><br>크기가 최소 184px x 184px인<br>500KB이하 jpg.gif 만 가능
                                </div>

                                <div class="screenshot_wrap" id="att_zone">
            ...
            <div class="inner">
                <div @class('w__500')>
                    ...
                    <div class="middle_text">
                        <p>프리미엄 물품 등록을 하시면 물품 리스트 상단에 판매 물품 노출이 가능합니다.</p>
                        <p>빠른 거래를 원하신다면 프리미엄 등록서비스를 이용하시기 바랍니다.</p>
                    </div>
                    <div class="clearfix mt-10 mb-10 text-center">프리미엄 잔여시간이 많을수록 물품리스트 상단에 노출됩니다.</div>
                    <div class="mileage_sea">내 사용가능한 마일리지 :
                        <span id="alias__mileage_span" class="text-pa">{{number_format($user->mileage)}}</span> 원
                    </div>
