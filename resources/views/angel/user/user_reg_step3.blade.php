        ...
        <div @class('ml-10 mr-10')>
            ...
            <form id="frmInfo" action="{{route('user_reg_step4')}}" method="post">
                ...
                <table id="tbl_user_profile">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="guide_add2">
                                    <input type="text" name="user_id" class="mw-200 angel__text mode-active text__new__green input__height__30 border__new_green" id="user_id" maxlength="12" required>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="guide_add">
                                    <input type="text" name="user_nickname" class="mw-200 angel__text mode-active text__new__green input__height__30 border__new_green" id="user_nickname" maxlength="16" required>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="guide_add">
                                    <input type="password" name="user_password" class="mw-200 angel__text mode-active text__new__green input__height__30 border__new_green" id="user_password" maxlength="16" required>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="guide_add">
                                    <input type="password" name="user_password_validate" class="mw-200 angel__text mode-active text__new__green input__height__30 border__new_green" id="user_password_validate" maxlength="16" required>
                        ...
                        <tr>
                            ...
                            <td class="mobile_area">
                                ...
                                -
                                <input type="text" name="user_mobileB" id="user_mobileB" maxlength="4" class="w60 angel__text mode-active text__new__green input__height__30 border__new_green" value="{{$phoneNum2}}" readonly="">
                                -
                                <input type="text" name="user_mobileC" id="user_mobileC" maxlength="4" class="w60 angel__text mode-active text__new__green input__height__30 border__new_green" value="{{$phoneNum3}}" readonly="">
                        ...
                        <tr>
                            <th>이메일</th>
                            <td class="email_area">
                                <input type="text" name="user_email" maxlength="30" class="w100x angel__text mode-active text__new__green input__height__30 border__new_green" required> @
                                <input type="text" name="user_email_direct" value="" maxlength="30" class="w100x angel__text mode-active text__new__green input__height__30 border__new_green">
                ...
                <div class="btn-groups_angel">
                    <input type="submit" value="회원가입" class="button-success">
                </div>
            </form>
