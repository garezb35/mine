            ...
            <div class="g_big_box1">
                <form id="frmSearch" action="" method="post">
                    ...
                    <div class="">
                        ...
                        <input type="text" name="search_price_min" maxlength="13" class="angel__text" style="width:140px; text-align: right;" value="{{$search_price_min}}" /> ~
                        <input type="text" name="search_price_max" maxlength="13" class="angel__text" style="width:140px; text-align: right;" value="{{$search_price_max}}" />
