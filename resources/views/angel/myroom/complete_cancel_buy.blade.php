...
<div class="container_fulids" id="module-teaser-fullscreen">
    ...
    <div class="pagecontainer">
        ...
        <div class="navtabs__react"> <a href="/myroom/complete/cancel_buy?type=sell"><span @if($type == 'sell')class="f_blue3 font-weight-bold" @endif>팝니다 취소한 내역</span></a> |
            <a href="/myroom/complete/cancel_buy?type=buy"><span @if($type == 'buy')class="f_blue3 font-weight-bold" @endif>삽니다 취소한 내역</span></a> </div>
