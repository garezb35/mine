...
<div class="g_container" id="g_CONTENT">
    ...
    <div class="g_content">
        ...
        <div class="g_tab">
            ...
            <div class=" icon_new"> <a href="http://trade.itemmania.com/myroom/mileage/payment/payment_phone>휴대폰번호 출금</a> </div>
            <div class=""><a href="http://trade.itemmania.com/myroom/mileage/payment/payment_list>마일리지 출금내역 보기</a></div>
            <div class="selected icon_new"><a href="http://trade.itemmania.com/myroom/mileage/payment/payment_phone_list>휴대폰번호 출금내역 보기</a></div>
        </div>
        <!-- ▲ 메뉴탭 //-->
        <div class="content">
