...
@section('head_attach')
    <link type="text/css" rel="stylesheet" href="/angel/myroom/mileage/change/css/change.css">
    <link type="text/css" rel="stylesheet" href="/angel/myroom/mileage/change/culturecash/css/index.css">
@endsection

@section('foot_attach')
    <script type="text/javascript" src="/angel/myroom/mileage/change/culturecash/js/index.js"></script>
