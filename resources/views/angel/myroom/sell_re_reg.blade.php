                    ...
                    <div class="ml-15 mr-15">
                            ...
                            <table class="table-primary border--gap border-top-0 sell__buy__table P__r">
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-top">
                                            ...
                                            <div class="float-left">
                                                <input type="text" class="mw-200 angel__text mode-active text__new__green input__height__30 border__new_green" name="user_character" maxlength="30" value="{{$user_character}}" id="user_character">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-top">
                                            <textarea id="user_text" name="user_text" class="txtarea w100 border__new_green" float__right>{{$user_text}}</textarea>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        @if($user_goods_type == 'division')
                            <table class="table-primary border--gap border-top-0 sell__buy__table P__r">
                                            ...
                                            <div class="parts__01" id="sr-template">
                                                <div class="h161">
                                                    <div style="overflow: auto">
                                                        <p class="fl ml-15 font-weight-bold mt-15">판매수량</p>
                                ...
                                <tr class="discount__part">
                                    <th class="border-top bg-gradient-wb">복수구매</th>
                                    <td class="border-top">
                                        <div class="discount">
                                            ...
                                            <div id="reven_discount">
                                                <input type="text" class="w60 " name="discount_quantity" id="discount_quantity" maxlength="10" readonly="" onfocus="$(this).blur();" value="{{number_format($discount_quantity)}}" @if(empty($discount_use))disabled @endif><span id="SpnDiscount"></span>x
                                                <input type="text" class="w60  discount_quantity_cnt" name="discount_quantity_cnt" id="discount_quantity_cnt" maxlength="10" value="{{number_format($discount_quantity_cnt)}}" @if(empty($discount_use))disabled @endif>번 구매시
                                                <input type="text" class="w60  discount_price" name="discount_price" id="discount_price" maxlength="10" value="{{number_format($discount_price)}}" @if(empty($discount_use))disabled @endif>원 할인
                                            </div>
                                        </div>
                                    </td>
                                </tr>
...
{{--                                    <th class="border-top">판매금액</th>--}}
{{--                                    <td class="border-top">--}}
{{--                                        <input type="text" name="user_division_unit" id="user_division_unit" maxlength="7" class="mw-200 angel__text mode-active text__new__green input__height__30 border__new_green" value="{{number_format($user_division_unit)}}" size="18">--}}
{{--                                        <span class="unit"></span> 개 당--}}
{{--                                        <div class="mt-5">--}}
{{--                                            <input type="text" name="user_division_price" id="user_division_price" maxlength="10" class="mw-200 angel__text mode-active text__new__green input__height__30 border__new_green" value="{{number_format($user_division_price)}}" size="18"> 원에 판매합니다.--}}
{{--                                        </div>--}}
...
{{--                                </tr>--}}
                                                ...
                                                <td style="vertical-align: top">
                                                    <div>
                                                        ...
                                                        <div class="text-center" style="margin-top: 36px">
                                                            <label @class('custom-select__1 height30')>
               ...
               <strong id="txtCurrentMileage" class="text-rock">{{number_format($cuser['mileage'])}}원</strong>)
                    ...
                    <div class="b_input_group">
                        <button type="submit" href="javascript:;" class="sell_reg" id="ok_btn">재등록</button>
                        <a href="/homepage" class="cancel_reg">등록 취소</a>
                    </div>
                </form>
            ...
            <div id="premiumPart" class="react___gatsby premium_info">
                <div class="inner">
                    <div class="w__500">
                        ...
                        <div class="middle_text">프리미엄 물품 등록을 하시면 물품 리스트 상단에 판매 물품 노출이 가능합니다.<br>빠른 거래를 원하신다면 프리미엄 등록서비스를 이용하시기 바랍니다.</div>
