...
<div @class('bg-white')>
    ...
    <div class="pagecontainer">
        ...
        <div>
            <a href="buy" class="btn-endsb @if(Request::get('search_type') != 'previous') selected  @endif">
                <input type="radio" name="list_type" value="2" @if(Request::get('search_type') != 'previous') checked @endif onclick="location.href='/myroom/complete/buy?type={{Request::get('type')}}'" @class('d-none')> 최근종료내역</a>
            <a href="javascript:void(0)" onclick="location.href='/myroom/complete/buy?search_type=previous&type={{Request::get('type')}}'" class="btn-endsb @if(Request::get('search_type') == 'previous') selected  @endif">
                <input type="radio" name="list_type" value="1" onclick="location.href='/myroom/complete/buy?search_type=previous&type={{Request::get('type')}}'" @class('d-none')> 이전종료내역</a>
        </div>
        <div class="navtabs__react p-left-0 p-right-0">
            <form id="frmSearch" action="" method="get">
                ...
                <ul class="g_sideway">
                    ...
                    <li>
                        <a href="/myroom/complete/buy?type=buy&search_type={{Request::get('search_type')}}&search_month={{Request::get('search_month')}}"><span @if(Request::get('type') == 'buy') class="f_blue3 font-weight-bold" @endif>삽니다 구매한 내역</span></a>
                    </li>
                    <li>
        ...
        <div @class('table-responsive')>
            <table class="table-primary tb_list tdbn thbn min600">
                <colgroup>
                    <col width="139">
                    <col width="71">
                    <col />
