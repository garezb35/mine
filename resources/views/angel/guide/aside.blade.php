...
<div class="aside">
    ...
    <div class="nav">
        <div class="@if($group == 'guide') on_active @endif nav_title"><a href="{{route('guide')}}">이용안내</a></div>
        <div class="@if($group == 'new_guide') on_active @endif nav_title"><a href="{{route('guide_howto')}}">초보자 가이드</a></div>
        <div class="@if($group == 'notices') on_active @endif nav_title"><a href="#">공지사항</a></div>
    </div>
    <!-- ▼ 배너 //-->
{{--    <div class="img_wrap">--}}
{{--        <p class="title">아이템천사 고객센터</p> <span class="SpGroup img_mania_call g_left"></span>--}}
