...
@section('head_attach')
    <link type="text/css" rel="stylesheet" href="/mania/user/join_agreement.css">
    <link type="text/css" rel="stylesheet" href="/mania/user/_join_title.css">

    <script type="text/javascript" src="/mania/_banner/js/banner_module.js?v=210209"></script>
@endsection

@section('foot_attach')
    <script type="text/javascript" src="/mania/user/join_agreement.js"></script>
@endsection
...
@section('content')
    <div class="g_container" id="g_CONTENT">
        ...
        <div class="agree_check_s">
            ...
            <label for="user_agreement1">아이템매니아 서비스 이용약관 및 아이템거래 서비스 이용약관에 동의합니다.
        ...
        <div class="clause_box">
            <ul class="sub_tab">
                <li>
                    <a href="javascript:;" class="on" id="portal_tab">아이템매니아 서비스 이용약관</a>
                </li>
                <li class="gb">|</li>
                <li>
...
① 회사에서 제공하는 서비스에는 아이템거래(판매관련, 구매관련, 상품 정보검색 관련 서비스), 게임매니아, 상품권몰 서비스 등이 있습니다.
...
아이템매니아 및 제 3자의 상품 또는 서비스에 대한 개인 맞춤형 광고 정보를 전송할수 있습니다.
</pre>
        </div>
        ...
        <div class="clause_box">
<pre>목적
(주)아이엠아이는 고객들에게 보다 다양한 정보를 제공하고, 서비스의 질을 향상시키기 위하여 당사의 비즈니스 파트너에게 본 활용동의서에 동의한 회원의 개인정보를 제공합니다.
