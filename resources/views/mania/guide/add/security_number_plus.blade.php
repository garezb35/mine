...
{{--                <div><a href="coupon.html">할인쿠폰</a></div>--}}
            ...
            <!-- ▲ 메뉴탭 //-->
{{--            <img src="http://img4.itemmania.com/new_images/guide/20160923_img_safenum.jpg" width="820" height="115" alt="">--}}
            <div class="guide_subtitle">
                <div class="f_bold">■ 안심번호 플러스</div>
            ...
            <img src="/mania/img/guide/screenshot/img_savenum01.gif" width="820" height="520" alt="">
            <div class="guide_subtitle">
                <span class="f_red1 f_bold">둘. </span>안심번호 신청 후 거래중인 상태가 되면 상대 거래자에게 휴대폰 번호가 안심번호로 노출됩니다.
            </div>
            <img src="/mania/img/guide/screenshot/img_savenum02.gif" width="820" height="250" alt="">
            <dl class="notice">
                <dt>[주의사항]</dt>
