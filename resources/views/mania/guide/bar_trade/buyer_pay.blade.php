    ...
    <div class="g_container" id="g_CONTENT">
        ...
        <div class="g_content">
            ...
            <ul class="trade_category" style="margin-top: 24px;">
                ...
                <li class="next_arrow"><img src="/mania/img/guide/screenshot/character/ico_guide_next.gif" width="18" height="18" alt=""></li>
                <li><a href="{{route('bar_buyer_pay')}}"><img class="btn" src="/mania/img/guide/screenshot/character/bar04_on.gif" width="134" height="43" alt="구매자의 결제"></a></li>
            ...
            <img class="" src="/mania/img/guide/screenshot/img_bar_pay01.png" width="820" height="" alt="">
            <div class="guide_subtitle">
                <span class="f_red1 f_bold">둘. </span>
                흥정신청된 물품 상세페이지에서 거래금액을 확인하신 후 <b>[결제하기]</b> 버튼을 클릭합니다.
            </div>
            <img src="/mania/img/guide/screenshot/img_bar_pay02.gif" width="820" height="" alt="">
