    ...
    <div class="g_container" id="g_CONTENT">
        ...
        <div class="g_content">
            ...
            <ul class="trade_category" style="margin-top: 24px;">
                ...
                <li class="next_arrow"><img src="/mania/img/guide/screenshot/character/ico_guide_next.gif" width="18" height="18" alt=""></li>
                <li><a href="{{route('bar_seller_app')}}"><img class="btn" src="/mania/img/guide/screenshot/character/bar03_on.gif" width="134" height="43" alt="판매자의 흥정수락"></a></li>
                <li class="next_arrow"><img src="/mania/img/guide/screenshot/character/ico_guide_next.gif" width="18" height="18" alt=""></li>
            ...
            <div class="g_subtitle_blue">판매자의 흥정수락</div>
            <div>흥정신청이 들어오면 판매자에게 SMS 안내 및 거래관련 메시지로 흥정신청을 알려드립니다</div>
            <div class="guide_subtitle">
                <span class="f_red1 f_bold">하나. </span>마이룸 > 판매관련 > [흥정신청된 물품]에서 흥정신청내역을 확인하실 수 있습니다.
            </div>
            <img class="" src="/mania/img/guide/screenshot/img_bar_acc01.png" width="820" height="" alt="">
            ...
            <img src="/mania/img/guide/screenshot/img_bar_acc02.png" width="820" height="" alt="">
