    ...
    <div class="g_container" id="g_CONTENT">
        ...
        <div class="g_content">
            ...
            <ul class="trade_category" style="margin-top: 24px;">
                ...
                <li><a href="{{route('bar_buyer_req')}}"><img class="btn" src="/mania/img/guide/screenshot/character/bar02_on.gif" width="134" height="43" alt="구매자의 흥정신청"></a></li>
                <li class="next_arrow"><img src="/mania/img/guide/screenshot/character/ico_guide_next.gif" width="18" height="18" alt=""></li>
                ...
                <li class="next_arrow"><img src="/mania/img/guide/screenshot/character/icon_guiade_end.gif" width="18" height="18" alt=""></li>
            ...
            <img class="" src="/mania/img/guide/screenshot/img_bar_req01.png" width="820" height="" alt="">
            <div class="guide_subtitle">
                <span class="f_red1 f_bold">둘. </span>
                주문물품 정보 및 판매자의 신용정보 등 을 확인 후 <b>[흥정신청]</b> 버튼을 클릭합니다.
            </div>
            <img src="/mania/img/guide/screenshot/img_bar_req02.png" width="820" height="" alt="">
            <div class="guide_subtitle">
                <span class="f_red1 f_bold">셋. </span>
                흥정금액 및 구매자 캐릭명을 입력하신 후 <b>[흥정신청]</b> 버튼을 클릭하시면 흥정신청이 완료 됩니다.
            </div>
            <img src="/mania/img/guide/screenshot/img_bar_req03.png" width="820" height="" alt="">
