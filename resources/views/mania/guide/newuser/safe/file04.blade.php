    ...
    <div class="g_container" id="g_CONTENT">
        ...
        <div class="g_content">
            ...
            <div class="top_menu">
                ...
                <a href="?file=04"><span class="g_black2 f_blue3 f_bold">신용등급 표시제</span></a> |
                <a href="?file=05"><span class="g_black2 ">개인정보보호</span></a> |
                <a href="?file=06"><span class="g_black2 ">보안시스템</span></a>
            </div>
            <div class="g_finish"></div>
            <div class="g_subtitle_blue">신용등급표시제</div>
            <img src="/mania/img/guide/screenshot/img_class.jpg" width="820" alt="" class="top_align">
        </div>
        <div class="g_finish"></div>
    </div>
    <!-- ▲ 컨텐츠 영역 //-->
