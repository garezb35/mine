    ...
    <div class="g_container" id="g_CONTENT">
        ...
        <div class="g_content">
            ...
            <ul id="guide_sell">
                ...
                <li>
                    <a href="?file=15" class="blue_arrow2 green_arrow">
            ...
            <div class="g_finish"></div>
            <div class="g_subtitle_blue">판매자 정보확인</div>
            <div class="guide_subtitle">
                <span class="f_red1 f_bold">하나. </span> 결제완료가 되면 <b>마이룸>구매관련>구매진행중인 물품</b>에서 판매자의 정보를 확인을 할 수 있습니다.
            </div>
            <img src="/mania/img/guide/screenshot/img_deciacc_04.gif" width="650" alt="">
            <div class="g_finish"></div>
            <div class="guide_subtitle">
                <span class="f_red1 f_bold">둘. </span>해당 물품의 물품정보에서 <b>거래필수정보를 확인</b>하신 후 판매자의 연락처로 판매자에게 연락을 합니다.<br>
                판매자와 연락이 되셨다면 판매자로부터 판매자 캐릭터명을 반드시 확인하시기 바랍니다
            </div>
            <img src="/mania/img/guide/screenshot/img_deciacc_05.png" width="820" alt="">
            <div class="g_finish"></div>
            <div class="guide_subtitle">
                <span class="f_red1 f_bold">셋. </span>판매자의 신용도를 확인 및 결제수단을 선택하신 후 [구매신청] 버튼을 클릭합니다.
            </div>
            <img src="/mania/img/guide/screenshot/img_deciacc_03.png" width="820" alt="">
            <div class="g_finish"></div>
            <div class="g_btn">
                <a class="btn-arrow-left" href="{{route('guide_howto2')}}?file=13" style="padding: 14px 50px; background: #079c43; color: white; font-size: 16px;">결제하기</a>
                <a class="btn-arrow-left" href="{{route('guide_howto2')}}?file=16" style="padding: 14px 50px; background: #079c43; color: white; font-size: 16px;">물품받기 및 인수확인</a>
            </div>
        </div>
        <div class="g_finish"></div>
    </div>
