    ...
    <div class="g_container" id="g_CONTENT">
        ...
        <div class="g_content">
            ...
            <ul id="guide_sell">
                ...
                <li>
                    <a href="?file=16" class="blue_arrow3 green_arrow">
            ...
            <div class="g_finish"></div>
            <div class="g_subtitle_blue">물품받기 및 인수확인</div>
            <div class="guide_subtitle">
                <span class="f_red1 f_bold">하나. </span> 판매자와 연락을 하시면서 게임상에서 판매자로부터 물품을 받습니다.
            </div>
            <img src="/mania/img/guide/screenshot/img_buyhand_01.png" width="650" alt="">
            <div class="g_finish"></div>
            <div class="guide_subtitle">
                <span class="f_red1 f_bold">둘. </span>물품을 정상적으로 받으셨다면 [인수확인] 버튼을 클릭합니다.
            </div>
            <img src="/mania/img/guide/screenshot/img_buyhand_02.png" width="820" alt="">
            <div class="g_finish"></div>
            <div class="guide_subtitle">
                <span class="f_red1 f_bold">셋. </span>현금영수증 정보를 확인 후 [물품인수확인] 버튼을 클릭하세요.<br>
                현금영수증 발급을 원하지 않으시면 [미발급] 을 선택해주시기 바랍니다.
            </div>
            <img src="/mania/img/guide/screenshot/img_buyhand_03.png" width="820" alt="">
            <div class="g_finish"></div>
            <div class="g_btn">
                <a class="btn-arrow-left" href="{{route('guide_howto2')}}?file=15" style="padding: 14px 50px; background: #079c43; color: white; font-size: 16px;">판매자 정보확인</a>
                <a class="btn-arrow-left" href="{{route('guide_howto2')}}?file=17" style="padding: 14px 50px; background: #079c43; color: white; font-size: 16px;">구매종료 물품확인</a>
            </div>
        </div>
        <div class="g_finish"></div>
    </div>
