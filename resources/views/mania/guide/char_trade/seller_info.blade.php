        ...
        <div class="g_content">
            ...
            <div class="g_content_inner">
                <ul class="trade_category">
                    <li><a href="{{route('safe_buy_reg')}}"><img class="first btn" src="/mania/img/guide/screenshot/character/char_buy01.gif" width="120" height="67" alt="구매 신청"></a></li>
                    <li class="next_arrow4"><img src="/mania/img/guide/screenshot/character/ico_guide_next.gif" width="18" height="18" alt=""></li>
                    <li><a href="{{route('safe_seller_info')}}"><img class="btn" src="/mania/img/guide/screenshot/character/char_buy02_on.gif" width="120" height="67" alt="판매자 정보확인"></a></li>
                    <li class="next_arrow4"><img src="/mania/img/guide/screenshot/character/ico_guide_next.gif" width="18" height="18" alt=""></li>
                ...
                <div class="guide_subtitle">
                    <span class="f_red1 f_bold">하나. </span>결제완료가 되면 <b>마이룸 > 구매관련 > 구매중인 물품</b>에서 판매자의 정보를 확인 할 수 있습니다.
                </div>
                <img src="/mania/img/guide/screenshot/img_char_buy2_01.png" width="820" height="" alt="">
                <div class="guide_subtitle">
                    <span class="f_red1 f_bold">둘. </span>해당 물품의 물품정보에서 <b>거래필수정보를 확인</b>하신 후 판매자의 연락처로 판매자에게 연락을 합니다.
                    <br>판매자와 연락이 되셨다면 판매자로부터 판매자 캐릭터명을 반드시 확인하시기 바랍니다.
                </div>
                <img src="/mania/img/guide/screenshot/img_char_buy2_02.png" width="820" height="" alt="">
