        ...
        <div class="g_content">
            ...
            <div class="g_content_inner">
                <ul class="trade_category">
                    ...
                    <li class="next_arrow4"><img src="/mania/img/guide/screenshot/character/ico_guide_next.gif" width="18" height="18" alt=""></li>
                    <li><a href="{{route('safe_take_over')}}"><img class="btn" src="/mania/img/guide/screenshot/character/char_buy04_on.gif" width="120" height="67" alt="물품받기 및 인수확인"></a></li>
                    <li class="next_arrow4"><img src="/mania/img/guide/screenshot/character/ico_guide_next.gif" width="18" height="18" alt=""></li>
                ...
                <img src="/mania/img/guide/screenshot/img_char_buy4_01.png" width="820" height="" alt="">
                <div class="guide_subtitle">
                    <span class="f_red1 f_bold">둘. </span>물품을 정상적으로 받으셨다면 [인수확인]버튼을 클릭합니다.
                </div>
                <img src="/mania/img/guide/screenshot/img_char_buy4_02.png" width="820" height="" alt="">
