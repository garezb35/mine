    ...
    <div class="g_container" id="g_CONTENT">
        ...
        <div class="g_content">
            ...
            <div class="g_content_inner">
                <ul class="trade_category">
                    ...
                    <li>
                        <a href="{{route('safe_buyer_info')}}">
                            <img class="btn" src="/mania/img/guide/screenshot/character/cha_03_on.gif" width="120" height="67" alt="구매자 정보확인">
                        </a>
                    </li>
                    <li class="next_arrow3"><img src="/mania/img/guide/screenshot/character/ico_guide_next.gif" width="18" height="18" alt=""></li>
                    <li>
                ...
                <img src="/mania/img/guide/screenshot/img_char_sell3_01.png" width="820" height="" alt="">
                <div class="guide_subtitle">
                    <span class="f_red1 f_bold">둘. </span>구매자와 연락이 되셨다면, 구매자로부터 <span class="f_bold"> 입력정보</span>를 반드시 확인하시기 바랍니다.
                </div>
                <img src="/mania/img/guide/screenshot/img_char_sell3_02.png" width="820" height="" alt="">
