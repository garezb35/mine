...
{{--            </div>--}}
            ...
            <div class="g_content_inner">
                <ul class="trade_category">
                    <li>
                        <a href="{{route('safe_char_trade')}}">
                            <img class="first btn" src="/mania/img/guide/screenshot/character/cha_01_on.gif" width="120" height="67" alt="판매할 물품등록">
                        </a>
                    </li>
                ...
                <img src="/mania/img/guide/screenshot/img_char_sell1_01.png" width="820" height="" alt="">
                <div class="guide_subtitle">
                    <span class="f_red1 f_bold">둘. </span>판매를 원하는 물품의 정보를 순서대로 입력하신 후 하단의 [판매등록] 버튼을 클릭합니다.<br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;팝니다 등록페이지의 팝니다 등록 알아두기를 먼저 꼼꼼히 읽어보세요.
                </div>
                <img src="/mania/img/guide/screenshot/img_char_sell1_02.png" width="820" height="" alt="">
                <div class="guide_subtitle">
