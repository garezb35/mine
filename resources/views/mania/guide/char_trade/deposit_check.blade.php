...
{{--            </div>--}}
            ...
            <div class="g_content_inner">
                <ul class="trade_category">
                    ...
                    <li>
                        <a href="{{route('safe_deposit_check')}}">
                            <img class="btn" src="/mania/img/guide/screenshot/character/cha_02_on.gif" width="120" height="67" alt="판매물품 입금확인">
                        </a>
                    </li>
                    <li class="next_arrow3"><img src="/mania/img/guide/screenshot/character/ico_guide_next.gif" width="18" height="18" alt=""></li>
                    <li>
                ...
                <img src="/mania/img/guide/screenshot/img_char_sell2_01.jpg" width="820" height="108" alt="">
