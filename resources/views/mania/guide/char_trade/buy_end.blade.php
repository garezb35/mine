        ...
        <div class="g_content">
            ...
            <div class="g_content_inner">
                <ul class="trade_category">
                    ...
                    <li class="next_arrow4"><img src="/mania/img/guide/screenshot/character/ico_guide_next.gif" width="18" height="18" alt=""></li>
                    <li><a href="{{route('safe_buy_end')}}"><img class="btn" src="/mania/img/guide/screenshot/character/char_buy05_on.gif" width="120" height="67" alt="구매종료 물품확인"></a></li>
                </ul>
                <div class="g_finish"></div>
                <div class="g_subtitle_blue">구매종료 물품확인</div>
                <div class="guide_subtitle">구매종료된 물품은 마이룸 > 종료내역에서 확인하실 수 있습니다.</div>
                <img src="/mania/img/guide/screenshot/img_char_buy5_01.png" width="820" height="" alt="">
