                ...
                <table class="g_blue_table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="g_left">
                                <input type="text" class="g_text mode-active rad13" name="user_character" id="user_character" maxlength="30"> 물품을 전달 받으실 본인의 캐릭터명 <span id="sub_text" class="g_red1"></span> </div>
