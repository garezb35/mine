@if($group == 'sell')
    <div class="bs_content sell_content">
        ...
        <a href="/myroom/sell/sell_pay_wait?strRelationType=pay" class="deposit_product">{{$pay_pending}}<span> </span></a> <span class="SpGroup arr_icon arr1"></span>
        <div class="step_title product_title">
            <br/>판매중인 물품
        </div>
        <a href="/myroom/sell/sell_ing?strRelationType=ing" class="sell_product">{{$selling_count}}<span> </span></a> <span class="SpGroup arr_icon arr2"></span>
        <div class="step_title complete_title">
            <br/>판매종료
        </div>
        <a href="/myroom/complete/sell" class="detail_btn">자세히보기<span class="SpGroup arr_right"></span></a>
    </div>
@else
<div class="bs_content buy_content">
    ...
    <a href="/myroom/buy/buy_pay_wait?strRelationType=pay" class="deposit_product">{{$pay_pending}}<span></span></a> <span class="SpGroup arr_icon arr1"></span>
    <div class="step_title product_title">
        <br/>구매중인 물품
    </div>
    <a href="/myroom/buy/buy_ing?strRelationType=ing" class="sell_product">{{$buying_count}}<span></span></a> <span class="SpGroup arr_icon arr2"></span>
    <div class="step_title complete_title">
        <br/>구매완료
    </div>
    <a href="/myroom/complete/buy" class="detail_btn">자세히보기<span class="SpGroup arr_right"></span></a>
</div>
@endif
