    ...
    <div class="react___gatsby settings_window" id="settings_window">
        <div class="inner"> <a href="javascript:;" class="close" id="disableSettings">닫기</a>
            <div class="title f-15"> 즐겨찾는 서비스 <span class="f-13">최대 8개를 선택할수 잇습니다.</span>
                <div class="r_area"> <a href="javascript:;" class="btn_white2 save" id="submit_menus">저장</a> <a href="javascript:;" class="btn_white2 init" id="reset_menus">초기화</a> </div>
            </div>
        ...
        <div class="top_area">
            ...
            <div class="service_wrap">
                <div class="service_set">
                    ...
                    <a href="javascript:;" id="enableSettings"><i class="sp_icon setting">설정</i></a>
                    <ul>
                        @foreach($list as $v)
                            <a href="{{getmyService()[$v['id']]['href']}}" target="_self">
                                <li>
                                    <span class="has-sprite counsel"></span><div class="f-16">{{getmyService()[$v['id']]['alias']}}</div>
                                </li>
                            </a>
                        @endforeach
                    </ul>
    ...
    <div class="content_center">
        ...
        <div class="d-flex w-100">
            ...
            <div class="w-50 sec_right no-border">
                <div class="title">
                    마일리지 충전
                    <div class="move_btn" id="putmoney">
