...
@section('content')
    ...
    <div class="container_fulids" id="module-teaser-fullscreen">
        <style>
            ...
            .item_filtered__average {
                padding: 18px 0;
                font-size: 14px;
                color: #67a3da;
            }
            .item_filtered__average li {
                word-spacing: 28px;
            }
            .cus_content {
            ...
            <form name="searchForm" id="searchForm" method="post" action="">
                ...
                <div class="search">
                    <div class="search_bar_wrap">
                        <input type="image" class="v_middle_img float__right" src="http://img2.itemmania.com/new_images/portal/center/btn_search_black.png" width="24" height="24" alt="검색">
                ...
                <div>
                    <ul class="item_filtered__average">
                        <li>추천검색어 | </li>
