...
<div class="container_fulids" id="module-teaser-fullscreen">
    ...
    <div id="dvGoodsInfo" class="modal_dialog green dvGoodsInfo">
        <div class="modal__title"> <img src="http://img4.itemmania.com/images/buy/titlep_info_gg.gif" width="102" height="19" alt="물품신청정보"> <img class="modal__close" src="http://img4.itemmania.com/images/icon/popup_x.gif" width="15" height="15" alt="닫기" onclick="g_nodeSleep.disable();"> </div>
