...
@section('content')
    <div class="container_fulids" id="module-teaser-fullscreen">
        ...
        <div class="empty-high"></div>
        <div class="item_filtered__all">
            <ul class="item_filtered item_filtered__average list_head">
                <li>
        ...
        <div class="react___gatsby item_regInfo" id="item_regInfo">
            <div class="inner">
                ...
                <div class="cont">
                    ...
                    <div class="b_input_group"> <a href="#" class="regInfo_btn buyapp" id="appBtn">구매신청</a> <a href="#" class="regInfo_btn detail" id="detailBtn">상세보기</a> </div>
                </div>
            </div>
        </div>
