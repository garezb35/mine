                ...
                <div id="Form_table" style="display: none;">
                    <form name="form_member" id="form_member" method="post" enctype="multipart/form-data">
                        ...
                        <div style="border: solid 1px #d1d1d1;">
                            ...
                            <div class="head_part">종료이유</div>
                            <div class="content_part reason_part">
                                <input id="reason01" type="radio" name="privates" value="물품 인계 후 구매자 연락 안됩니다." class="g_radio">
                                <label for="reason01">물품 인계 후 구매자 연락 안됩니다.</label>
                                <br>
                                <input id="reason02" type="radio" name="privates" value="물품 인계 후 구매자 물품인수확인 안됩니다." class="g_radio">
                                <label for="reason02">물품 인계 후 구매자 물품인수확인 안됩니다.</label>
                                <br>
                                <input id="reason03" type="radio" name="privates" value="물품 인계 후 종료안됩니다." class="g_radio">
                                <label for="reason03">물품 인계 후 종료안됩니다.</label>
                                <br>
