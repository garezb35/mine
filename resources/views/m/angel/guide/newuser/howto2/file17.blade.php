    ...
    <div class="container_fulids" id="module-teaser-fullscreen">
        ...
        <div class="pagecontainer">
            ...
            <ul id="guide_sell">
                ...
                <li>
                    <a href="?file=17" class="blue_arrow4 green_arrow2">
                        <div style="padding-right: 0; padding-left: 30px;">구매종료<br>물품확인</div>
                    </a>
                </li>
            </ul>
            <div class="empty-high"></div>
            <div class="highlight_contextual">구매종료 물품확인</div>
            <div class="guide_subtitle">
                구매종료된 물품은 마이룸 > 종료내역에서 확인하실 수 있습니다.
            </div>
            <img src="/angel/img/guide/screenshot/img_buyclose_01.png" width="820" alt="">
            <div class="empty-high"></div>
