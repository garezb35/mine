    ...
    <div class="container_fulids" id="module-teaser-fullscreen">
        ...
        <div class="pagecontainer">
            ...
            <div class="gray_box">
                ...
                <div class="inner_box">
                    <div class="font-weight-bold">▶보험 세부 내용</div>
                    <ul class="g_list">
                ...
                <div class="divi_line"></div>
                <div class="inner_box">
                    <div class="font-weight-bold">▶고객보호 및 거래안전을 위한 노력</div>
                    <ul class="g_list">
