...
{{--            </div>--}}
            ...
            <div class="g_content_inner">
                <ul class="trade_category">
                    ...
                    <li>
                        <a href="{{route('safe_deposit_check')}}">
                            <img class="btn" src="/angel/img/guide/screenshot/character/cha_02_on.gif" width="120" height="67" alt="판매물품 입금확인">
                        </a>
                    </li>
                    <li class="next_arrow3"><img src="/angel/img/guide/screenshot/character/ico_guide_next.gif" width="18" height="18" alt=""></li>
                    <li>
                ...
                <div class="empty-high"></div>
                <div class="highlight_contextual">판매물품 입금확인</div>
                <div class="guide_subtitle">
                    구매자가 판매물품의 결제를 마치시면 판매자에게 입금확인 SMS알림 메시지를 전송해 드립니다.<br>
                    (단, SMS 수신동의를 체크해제 하신 경우 전송되지 않습니다.)
                </div>
                <img src="/angel/img/guide/screenshot/img_char_sell2_01.jpg" width="820" height="108" alt="">
