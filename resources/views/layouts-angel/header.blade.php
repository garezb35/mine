                    ...
                    <li class="gs_search_item">
                        <form id="search-overlay-container" method="post" action="" onsubmit="return searchbarSubmit();">
                            ...
                            <div class="top_game_searchbar">
                                ...
                                <button type="submit" class="search__submit" id="search__submit" title="검색"> <i class="fa fa-search" style="font-size: 19px;color: #02c6bc"></i> </button>
    ...
    <div class="nav_wrap">
        <div class="content_center headernav-with">
            <div class="top-leftli">
                ...
                <b class="sjx-lb"></b>
                <div class="dropdown">
                    <a href="javascript:void(0);" rel="nofollow" id="dropdown-wz">전체 게임<img src="https://www.5mmo.com/templates/game/images/topicojg.png"></a>
...
{{--                        </div>--}}
            ...
            <ul class="nav nav_menu_nodemon">
                <li class="highlight" ><a @if(Route::getCurrentRoute()->getName() == 'sell') style="color: #3295d3" @endif  href="/sell">판매등록</a></li>
                <li class="highlight" ><a @if(Route::getCurrentRoute()->getName() == 'buy') style="color: #edb528" @endif  href="/buy">구매등록</a></li>
                <li ><a @if(str_contains(Request::url(),'/myroom/my_mileage/index_c')) style="color: #ea70a5" @endif href="/myroom/my_mileage/index_c" >마일리지 충전</a></li>
