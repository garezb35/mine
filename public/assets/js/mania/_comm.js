...
var _myService = {
    ...
    setLastSearch: function() {
        ...
        _cookie.add("userSerachListNew", JSON.stringify(j), null, "/", ".cake6978.com")
    },
    ...
    deleteLastSearch: function(b) {
        ...
        if (a.length > 0) {
            var a = JSON.parse(a);
            a.splice(b, 1);
            _cookie.add("userSerachListNew", JSON.stringify(a), null, "/", ".cake6978.com")
        }
    },
    deleteListAll: function(a) {
        _cookie.remove("userSerachListNew", "/", ".cake6978.com");
        a.remove()
    },
