...
function makeChat(data){
    ...
    var checkAnother = data.whoAmI == "seller"? '<div class="chat_info me">':'<div class="chat_info another">';
    var statement = '';
    switch (data.whoAmI) {
        case "buyer":
            ...
            statement+= '<img src=\'/angel/img/level/'+data.image+'\' width=\'20\'  alt=\'구매자\'>';
            statement+= '</div>';
        ...
        case "seller":
            ...
            statement+= checkAnother;
            statement+= '<div class="user_identity_image list_content">';
            statement+= '<img src=\'/angel/img/level/'+data.image+'\' width=\'20\'  alt=\'판매자\'>';
            statement+= '</div>';
            statement+= '<div class="list_content">';
